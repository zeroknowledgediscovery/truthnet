...
\addplot[scatter,only marks,mark options={mark size=1.2pt,fill=black,opacity=.5},point meta=explicit] table[x=kappa,y=nu, meta=chi] {\datafileA};
...
%      grid style={dashed,semithick,draw=gray, opacity=.25},
%   ] 
% \pgfplotstableread[col sep=comma]{Figures/plotdata/expdata_res.csv}\datafileA

%\addplot[scatter,only marks,mark options={mark size=1.2pt},point meta=explicit,] table[x=kappa,y=nu,meta=mu,discard if ={chi}{-1},] % {\datafileA};
% \addplot[scatter,only marks,mark options={mark size=1.2pt,fill=black,opacity=.5},point meta=explicit] table[x=kappa,y=nu, meta=mu] {\datafileA};
